...
import StoreImg from '../assets/images/kyn-logo.png';
...
const Header = () => {
  ...
  const handleLogout = () => {
    ...
    window.location.href = '/register'; // Redirect to the home page or the desired location
  };
  ...
  return (
        ...
        <div className="container">
            <Link className="navbar-brand d-flex align-items-center" to="/">
                ...
                style={{ width: '90px', height: '90px' }}></img> Know Your Neighborhood</Link>
            ...
            <ul className="navbar-nav ms-auto">
                ...
                <li className="nav-item mx-0 mx-lg-1">
                    ...
                    <i className="fa fa-server" aria-hidden="true"></i> Neighbors</Link></li>
                <li className="nav-item mx-0 mx-lg-1">
                    <Link to="/about" className="nav-link py-3 px-0 px-lg-3 rounded">
                    <i className="fa fa-users" aria-hidden="true"></i> About</Link></li>
                <li className="nav-item mx-0 mx-lg-1">
                    <Link to="/contact" className="nav-link py-3 px-0 px-lg-3 rounded">
                    <i className="fa fa-mobile" aria-hidden="true"></i> Contact</Link></li>
                <li className="nav-item mx-0 mx-lg-1">
                ...
                <li className="nav-item mx-0 mx-lg-1">
                    ...
                    <i className="fa fa-user" aria-hidden="true"></i> Login</Link></li>
                <li className="nav-item mx-0 mx-lg-1">
                    <Link to="/terms" className="nav-link py-3 px-0 px-lg-3 rounded">
                    <i className="fa fa-book" aria-hidden="true"></i> Terms and Conditions</Link></li>
                </>
                )} 
            </ul>
            </div>
